...
// .wrangler/tmp/pages-QQvXAL/bundledWorker-0.10554528299590393.mjs
...
var V = /* @__PURE__ */ __name2((e, t, n) => (n = e != null ? ne(ie(e)) : {}, ce(t || !e || !e.__esModule ? U(n, "default", { value: e, enumerable: true }) : n, e)), "V");
var _;
var u = M(() => {
  _ = { collectedLocales: [] };
});
...
async function Z(e) {
  ...
  try {
    ...
    switch (e.method) {
      ...
      case "POST": {
        let i = globalThis[me], r = /* @__PURE__ */ __name2(async () => {
          let o = await e.json();
...
// .wrangler/tmp/pages-QQvXAL/6m9i1cz3f6f.js
...
// .wrangler/tmp/bundle-iiXnpk/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-iiXnpk/middleware-loader.entry.ts
